...
const styles = StyleSheet.create({
  ...
  gridContainer: {
    borderWidth: 1,
    borderColor: "#333", // Grid border color
    padding: 10,
  ...
  input: {
    flex: 1,
    borderWidth: 1,
    borderColor: "#666", // Input border color
    padding: 10,
    width: 100, // Increase the width of each cell
    height: 50, // Decrease the height of each cell
  },
  downloadButton: {
    backgroundColor: "#000000", // Change the background color of the button
